...
// Define the type for ToastProvider props
type ToastProviderProps = React.ComponentProps<typeof ToastPrimitives.Provider>;

// Define the type for ToastViewport props
type ToastViewportProps = React.ComponentProps<
...
const ToastViewport = React.forwardRef<any, ToastViewportProps>(
  ({ className, ...props }, ref) => (
